...
delete ans[t];
	...
	document.getElementById("demo").style.color='#FF0080';
	...
	else if(ans=="F")
                    {
                            ...
                            document.getElementById('ava').src='44fU.gif';                 
                    }
                    else if(ans=="L")
                    {
                            //res="LOVER";
                            ...
                            document.getElementById("demo").style.color='#FF0080';
                            document.getElementById('ava').src='lover.gif';
                    }
                    else if(ans=="A")
                    {
                            //res="AFFECTION";
                            ...
                            document.getElementById('ava').src='affection2.gif';
                    } 
                    else if(ans=="M")
                    {
                            //res="MARRIAGE";
                            ...
                            document.getElementById('ava').src='marriage.gif';
                    }
                    else if(ans=="E")
                    {	
                            //res="ENEMY";
                            ...
                            document.getElementById('ava').src='Enemy.gif';
                    }
                    else if(ans=="S")
                    {
                            //res="SISTER";
							document.getElementById("demo").innerHTML = 'SIBLINGS';
                            document.getElementById("demo").style.color='violet';
                            document.getElementById('ava').src='Siblins.gif';
                    }
